...
4. If mutation tools are unavailable, return a precise action plan instead of simulating changes.
5. After each mutation, rely on the tool result rather than assumptions.
6. Finish with a concise summary of what changed.
